...
public class GlobalExceptionHandler {
        ...
        public ResponseEntity<ApiResponse> handleInsufficientProductQuantityException(
        ...
        public ResponseEntity<ApiResponse> handleIOException(IOException ex) {
                ...
                ApiResponse apiResponse = new ApiResponse("Error", HttpStatus.INTERNAL_SERVER_ERROR.value(),
                                "Error handling file upload", null);
        ...
        public ResponseEntity<ApiResponse> handleMultipartException(MultipartException ex) {
                ...
                ApiResponse apiResponse = new ApiResponse("Error", HttpStatus.BAD_REQUEST.value(),
                                "Invalid file upload", null);
